...
function renderPrice() {
  ...
  document.querySelectorAll('btn').forEach (onePizza => {
    if (state === true) {
      onePizza.setAttribute('class', '.price li').styleDisplay = "block"
    } else if (state === false) {
      onePizza.setAttribute('class', '.price li').styleDisplay = "hidden"
    }
  })
}
